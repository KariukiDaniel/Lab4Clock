...
public class Lab4Clock {
    ...
    public Lab4Clock(int hours, int minutes, int seconds)
    {
    ...
    public boolean equals(Lab4Clock otherClock)
	  {
        return(hr == otherClock.hr
          ...
          //               sec = otherTime.sec;
    public void makeCopy(Lab4Clock otherClock)
	  {
        hr = otherClock.hr;
        min = otherClock.min;
        sec = otherClock.sec;
    ...
    public Lab4Clock getCopy()
    {
	      Lab4Clock temp = new Lab4Clock();
